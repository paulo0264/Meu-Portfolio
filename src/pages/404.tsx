...
const NotFound = () => {
  return (
    <>
      <Head>
        <title>404 | Paulo</title>
      </Head>
      <div className="flex flex-col items-center text-center mt-12 md:mt-24 gap-8 px-6 md:px-32">
        <h1 className="text-5xl sm:text-7xl font-bold text-orange-500">404</h1>
        ...
        <Link
          href="/"
          className={`${roboto.className} p-4 bg-h-blue-500 rounded-xl text-orange-500 mt-5 md:mt-5 md:text-xl w-fit`}
        >
